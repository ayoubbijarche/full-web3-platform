        ...
        if (result.success && result.challenges) {
          ...
          const userCreatedChallenges = result.challenges
            ...
            .map(challenge => ({
              ...
              image: challenge.image ? `http://localhost:8090/api/files/challenges/${challenge.id}/${challenge.image}` : undefined
            }));
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="flex gap-8 items-start">
            ...
            <div className="w-40 h-40 rounded-full overflow-hidden flex-shrink-0 border-2 border-[#b3731d]">
              {user.avatar ? (
                <Image
                  src={`http://localhost:8090/api/files/users/${user.id}/${user.avatar}`}
