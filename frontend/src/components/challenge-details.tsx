                      ...
                      <div className="flex items-center gap-1 mb-1">
                        <Avatar className="h-4 w-4">
                          {message.expand?.sender?.avatar ? (
                            <Image
                              src={`http://api.coinpetitive.com/api/files/users/${message.expand.sender.id}/${message.expand.sender.avatar}`}
                ...
                <div className="flex items-center gap-2 mb-2">
                  <Avatar className="h-5 w-5">
                    {submission.expand?.participant?.avatar ? (
                      <Image
                        src={`http://api.coinpetitive.com/api/files/users/${submission.expand.participant.id}/${submission.expand.participant.avatar}`}
                ...
                <div className="aspect-video bg-gray-200 rounded-lg overflow-hidden relative">
                  {submission.video && (
                    submission.video.startsWith('http') ? (
                      ...
                      <video 
                        src={`http://api.coinpetitive.com/api/files/${submission.collectionId || 'video_submitted'}/${submission.id}/${submission.video}`}
